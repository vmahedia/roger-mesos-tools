...
class RogerInit(object):
    ...
    def parse_args(self):
      self.parser = argparse.ArgumentParser(prog='roger init', description=describe())
    ...
    def main(self):
      ...
      if file_exists:
        ...
        self.createAppConfig(config_dir, config_file, args.app_name, args.project_name, args.framework)

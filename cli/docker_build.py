...
class Docker(object):
    ...
    def docker_build(self, dockerUtilsObj, appObj, directory, repo, projects, path, image_tag, custom_docker_file_exists, docker_file):
        ...
        with swaparoo():
            dockerUtilsObj.docker_build(image_tag, custom_docker_file_exists, docker_file)

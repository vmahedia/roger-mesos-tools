    ...
    def main(self, settingObj, appObj, hooksObj, dockerUtilsObj, dockerObj, args):
        ...
        try:
            ...
            try:
                ...
                input_metric = "roger-tools.roger_build_time," + "app_name=" + str(args.application) + ",outcome=" + str(execution_result) + ",config_name=" + str(config_name) + ",environment=" + str(args.env) + ",user=" + str(settingObj.getUser())
